...
\declaretheorem[%
	style=thmbluebox,name=مبرهنة,numberwithin=section]{theorem}
\declaretheorem[style=thmbluebox,name=Lemma,sibling=theorem]{lemma}
\declaretheorem[style=thmbluebox,name=Proposition,sibling=theorem]{proposition}
\declaretheorem[style=thmbluebox,name=Corollary,sibling=theorem]{corollary}
\declaretheorem[style=thmredbox,name=مثال,sibling=theorem]{example}
...
\theoremstyle{theorem}
\declaretheorem[name=سؤال,sibling=theorem,style=thmblackbox]{ques}
\declaretheorem[name=تمرين,sibling=theorem,style=thmblackbox]{exercise}
\declaretheorem[name=ملاحظة,sibling=theorem,style=thmgreenbox]{remark}
\declaretheorem[name=ملاحظة,sibling=theorem,style=thmgreenbox*]{remark*}
...
\newtheorem{problem}{مسألة}[chapter]
\renewcommand{\theproblem}{\thechapter\Alph{problem}}
\newtheorem{sproblem}[problem]{مسألة}
\newtheorem{dproblem}[problem]{مسألة}
